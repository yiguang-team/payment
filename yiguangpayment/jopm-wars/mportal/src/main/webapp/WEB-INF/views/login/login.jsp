...
<SCRIPT type=text/javascript src="${ctx}/template/admin/js/jsbn.js"></SCRIPT>

<SCRIPT type=text/javascript src="${ctx}/template/admin/js/prng4.js"></SCRIPT>

<SCRIPT type=text/javascript src="${ctx}/template/admin/js/rng.js"></SCRIPT>


<SCRIPT type=text/javascript src="${ctx}/template/admin/js/base64.js"></SCRIPT>

<SCRIPT type=text/javascript src="${ctx}/template/admin/js/common.js"></SCRIPT>

<SCRIPT type=text/javascript
	src="${ctx}/template/admin/js/RSA/Barrett.js"></SCRIPT>
<SCRIPT type=text/javascript
	src="${ctx}/template/admin/js/RSA/BigInt.js"></SCRIPT>
<SCRIPT type=text/javascript src="${ctx}/template/admin/js/RSA/RSA.js"></SCRIPT>
...
<!--[if lte IE 9]>
		<link rel="stylesheet" href="${ctx}/template/ace/assets/css/ace-part2.css" />
	<![endif]-->
<link rel="stylesheet" href="${ctx}/template/ace/assets/css/ace-rtl.css" />
						...
						<div class="center">
							<h1 style="padding-top: 20%;">
								<span class="white" id="id-text2"
									style="font-family: Microsoft YaHei;">翼光联运支付管理系统</span>
							</h1>
							<!--<h4 class="blue" id="id-company-text">登录</h4>-->
						</div>
									...
									<div class="widget-main">
										...
										<fieldset>
											<form id='loginForm' method='post' action='login'>
												<INPUT id='enPassword' type=hidden name='enPassword' /> <input
													type="hidden" id="rsaPassword" name="rsaPassword" /> <input
													type="hidden" id="exponent" name="exponent"
													value="${exponent}" /> <input type="hidden" id="modulus"
													name="modulus" value="${modulus}" /> <label
													class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" name="username" id="username"
														value="${username}" class="form-control" placeholder="用户名" />
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header red lighter bigger">
											<i class="ace-icon fa fa-key"></i> 忘记密码
										</h4>

										<div class="space-6"></div>
										<p>请输入注册时的邮箱，以便您找回密码</p>
