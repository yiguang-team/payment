...
<body class="no-skin">
	<form id="listForm" name="listForm" method="post"
		action="${ctx}/depot/report/depotReportList">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-container">
									...
									<span class="labeltxt fl">模&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;式：</span> <select name="modelId"
										...
										<br/><br/>
										<span
										class="labeltxt fl">计&nbsp;&nbsp;费&nbsp;&nbsp;点：</span> <select name="chargingPointId"
										id="chargingPointId" class="form-control fl"
										style="width: 150px; float: left;">
										<c:choose>
									...
									</select> <span class="labeltxt fl">提卡方式：</span> <select
										name="extractType" id="extractType" class="form-control fl"
										style="width: 150px; float: left;">
										<c:choose>
											<c:when test="${fn:length(extractTypeList) > 0}">
												<c:forEach items="${extractTypeList}" var="option">
													<option value="${option.value}"
														<c:if test="${option.value == extractType}">selected="true"</c:if>>${option.text}</option>
												</c:forEach>
											</c:when>
											<c:otherwise>
												<option value=""></option>
