...
<body class="no-skin">
	<form id="listForm" name="listForm" method="post"
		action="${ctx}/payment/report/orderReportList">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-container">
									...
									<span class="labeltxt fl">模式：</span> <select name="modelId"
									...
									</select> <span class="labeltxt fl">开始时间：</span> <input id="beginDate"
										...
										class="labeltxt fl">渠道名称：</span> <select name="channelId"
									...
									</select> <span class="labeltxt fl">渠道类型：</span> <select
									...
									</select> <br /> <br /> <span class="labeltxt fl">省份：</span> <select
										name="provinceId" id="provinceId" class="form-control fl"
										style="width: 150px; float: left;">
										<c:choose>
									...
									</select> <span class="labeltxt fl">商户名称：</span> <select
									...
									</select> <span class="labeltxt fl">计费面值：</span> <select
										name="faceAmount" id="faceAmount" class="form-control fl"
										style="width: 150px; float: left;">
										<c:choose>
											<c:when test="${fn:length(faceAmountList) > 0}">
												<c:forEach items="${faceAmountList}" var="option">
													<option value="${option.text}"
														<c:if test="${option.text == faceAmount}">selected="true"</c:if>>${option.text}</option>
												</c:forEach>
											</c:when>
											<c:otherwise>
												<option value=""></option>
