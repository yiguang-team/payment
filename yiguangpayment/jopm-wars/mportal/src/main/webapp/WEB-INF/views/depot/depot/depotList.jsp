...
<body class="no-skin">
	<form id="listForm" name="listForm" method="post"
		action="${ctx}/depot/depot/depotList">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-container">
									<span class="labeltxt fl">卡&nbsp;&nbsp;&nbsp;&nbsp;号：</span> <input
										class="fl form-text" type="text" id="cardId" name="cardId"
										value="${cardId}"> <span class="labeltxt fl">批次编号：</span>
									<input class="fl form-text" type="text" id="batchId"
										name="batchId" value="${batchId}"> <span
										class="labeltxt fl">商&nbsp;&nbsp;&nbsp;&nbsp;户：</span> <select
									...
									</select> <span class="labeltxt fl">产&nbsp;&nbsp;&nbsp;&nbsp;品：</span> <select
										name="productId" id="productId" class="form-control fl"
										style="width: 150px; float: left;">
										<c:choose>
									...
									</select> <span class="labeltxt fl">面&nbsp;&nbsp;&nbsp;&nbsp;值：</span> <input
										class="fl form-text" type="text" id="faceAmount"
										name="faceAmount" value="${faceAmount}"> <br /> <br />
									<span class="labeltxt fl">状&nbsp;&nbsp;&nbsp;&nbsp;态：</span> <select
										name="status" id="status" class="form-control fl"
										style="width: 150px; float: left;">
										<c:choose>
											...
											<tbody>
												...
												<c:choose>
													<c:when test="${fn:length(mlist) > 0}">
														<c:forEach items="${mlist}" var="depot" varStatus="status">
															<tr>
																<td class="center">${(page-1)*pageSize+status.index+1}</td>

																<td>${depot.pointVO.merchantLabel}</td>
																<td>${depot.pointVO.productLabel}</td>
																<td>${depot.pointVO.provinceLabel}</td>
																<td>${depot.pointVO.cityLabel}</td>
																<td>${depot.pointVO.faceAmount}</td>
																<td>${depot.cardId}</td>
																<td>***</td>
																<td>${depot.batchId}</td>
																<td><span
																	<c:if test="${depot.status == 1}">class="label label-sm label-inverse arrowed-in"</c:if>
																	<c:if test="${depot.status == 3}">class="label label-sm label-inverse arrowed-out"</c:if>
																	<c:if test="${depot.status == 2}">class="label label-sm label-success"</c:if>>
																		${depot.statusLabel} </span></td>
															</tr>
														</c:forEach>
													</c:when>
													<c:otherwise>
