...
<body>
<div class="mg10"></div>
	<form id="inputForm" action="privilege_add_tree"  method="post">
		<table class="input">
			<tr>
				<th>
				...
				<td>
			        ...
			        <#elseif privilegename != "0">
							 ${privilegename}${parentprivilegeId!""}
			        </#if>
					<input type="hidden" id="parentPrivilegeId" name="parentPrivilegeId" class="ipt" value="${parentprivilegeId!""}"/>	
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="privilegeName" name="privilegeName" class="ipt" maxlength="200" />	 
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="permissionName" name="permissionName" class="ipt" maxlength="200" />	 
				</td>
			</tr>
			<tr>
				<th>
